...
assert_eq('قیمت مثبت زیر یک تومان، قیمت قبلی را حفظ می‌کند',
    LMC_Stock_Sync::price_for_site(['price' => '9']), null);
assert_eq('اولین تومان مثبت از بین نمی‌رود',
    LMC_Stock_Sync::price_for_site(['price' => '10']), '1');
assert_eq('تقسیم پول بزرگ از محدوده عدد صحیح PHP عبور نمی‌کند',
    LMC_Stock_Sync::price_for_site(['price' => '99999999999999999999']), '9999999999999999999');
