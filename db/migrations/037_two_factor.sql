...
--
-- کاربری که هنوز ۲FA راه نینداخته و نقشش در فهرست است، فقط یک نشست
-- محدود راه‌اندازی می‌گیرد. آن نشست به هیچ داده یا عملیات برنامه
-- دسترسی ندارد و فقط مسیرهای ثبت عامل دوم را باز می‌کند.
...
COMMENT ON FUNCTION identity.needs_second_factor IS
  'کاربری که عامل دومی راه انداخته باشد، از آن به بعد بدون آن وارد نمی‌شود.';

/** آیا نقش این کاربر در فهرست الزام است؟ */
