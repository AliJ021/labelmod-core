...
--   بدهی تأمین‌کننده به اندازه **بهای فاکتور** کم می‌شود.
--   موجودی به اندازه **ارزش دفتری** (بهای فاکتور + سهم حمل) کم می‌شود.
--
-- تفاوتشان هزینه حملِ کالایی است که پس فرستاده شده و باربری آن را
-- برنمی‌گرداند. یک زیان واقعی است و سرفصل خودش را می‌خواهد — وگرنه
-- بی‌صدا در بدهی تأمین‌کننده یا ارزش موجودی گم می‌شود.
('purchase_return','payable',    'debit', '2101','supplier','کاهش بدهی تأمین‌کننده بابت برگشت', 1),
('purchase_return','input_tax',  'credit','1401', NULL,     'معکوس اعتبار مالیات خرید',        2),
('purchase_return','inventory',  'credit','1301', NULL,     'خروج کالای برگشتی از انبار',      3),
('purchase_return','charge_loss','debit', '5102', NULL,     'هزینه حملِ کالای پس‌فرستاده',      4),
