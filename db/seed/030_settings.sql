...
('costing.method', '"last_purchase"'::jsonb,
 ...
 NULL, NULL, NULL,
 'آخرین قیمت خرید (پیش‌فرض): قیمت کالا همان نرخ آخرین خرید است و کل موجودی با آن ارزیابی می‌شود — روش رایج در بازار. میانگین موزون: قیمت کالا میانگین وزنی همه خریدهاست. ⚠️ استاندارد حسابداری شماره ۸ ایران میانگین موزون، FIFO و شناسایی ویژه را می‌پذیرد؛ پیش از اظهارنامه با حسابدار تأیید کنید.',
