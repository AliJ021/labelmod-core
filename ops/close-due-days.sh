...
#
#   0 3 * * *  DATABASE_URL='…' LABELMOD_ACTOR='…' \
#              /srv/labelmod/ops/close-due-days.sh >> /var/log/labelmod-close.log 2>&1
#
# `LABELMOD_ACTOR` شناسه کاربری است که این کار به نامش در لاگ حسابرسی
# ثبت می‌شود. یک کاربر مخصوص بسازید (مثلاً «سیستم») و رمزش را قفل
# کنید؛ نام همان کاربر کنار هر سند شبانه می‌ماند.
#
...
: "${LABELMOD_ACTOR:?LABELMOD_ACTOR (شناسه کاربر عامل) تنظیم نشده است}"
